...
Which problems does your idea solve? How common or frequent is this problem? What is your personal motivation? Why is this topic important or interesting? It reduces over attention or anxiety and allows people to refocus. 
...
def main():
   ...
   users = [1891, 2652, 3800, 11611, 1757]

   totPop = sum(pop)
   totUsers = sum(fishers)
...
It can be enhanced with user generated content. 
